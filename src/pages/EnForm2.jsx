...
export default function GuForm() {
  ...
  const departments = {
    ...
    YagShala: "યજ્ઞશાળા",
    ResidenceDivision: "ઉતારા વિભાગ",
    KitchenDivision: "રસોડા વિભાગ",
    "Computer / Office Division": "કમ્પ્યુટર / ઓફિસ વિભાગ",
    "Video / Graphics Division": "વિડિઓ / ગ્રાફિક્સ વિભાગ",
    MedicalDivision: "મેડિકલ વિભાગ",
    TransportationDivision: "પરિવહન વિભાગ",
    InquiryDivision: "પૂછપરછ વિભાગ",
    CleaningDivision: "સ્વચ્છતા વિભાગ",
  };
  ...
  const getImage = () => {
    switch (device) {
      case "desktop":
        return "/public/desktop_image.png";
      case "tablet":
        return "/public/ipad 1.png";
      default:
        return "/public/logo4.png";
    }
  };
